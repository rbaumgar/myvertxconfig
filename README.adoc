...
. (No longer needed)Be sure that view access rights for the service account are added before deploying your booster.
+
[source,bash,options="nowrap",subs="attributes+"]
----
...
myvertxconfig-MY_PROJECT_NAME.LOCAL_OPENSHIFT_HOSTNAME
----
